...
------------------------"  >> ../example_errs_bibtex.txt
      ...
      # warning in 3.4+
      grep -P '(?:[Ee]rror|[Ww]arning): (?!Using fall-back|prefixnumbers option|Empty biblist|Font shape|Command \\mark)' ${f%.tex}.log >> ../example_errs_bibtex.txt
...
------------------------"  >> ../example_errs_biber.txt
      grep -P '(?:[Ee]rror|[Ww]arning): (?!Using fall-back|prefixnumbers option|Empty biblist|Font shape|Command \\mark)' ${f%.tex}.log >> ../example_errs_biber.txt
