...
\end{lstlisting}
%
will sort exactly the same. The default setting of this option always sorts in the order shown in the example, hat is, by default, truncated names lists always sort after any name lists identical to the point of truncation.
