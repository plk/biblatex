...
With \bibtex, this field holds the initial character of the string used during sorting.\\
\BiberOnlyMark With \biber, this field holds a hash of the (locale-specific) Unicode Collation Algorithm primary weight of the initial glyph of the string used during sorting. This is useful when subdividing the bibliography alphabetically and is used internally by \cmd{bibinitsep} (see \secref{use:fmt:len}).
...
\item \bibfield{sortinit} is now a hash with \biber\see{aut:bbx:fld:gen}
\end{release}
