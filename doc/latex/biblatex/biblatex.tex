...
\end{valuelist}
%
Note that \opt{edtf} format will enforce \kvopt{dateera}{astronomical}, \kvopt{datezeros}{true}, \kvopt{timezeros}{true}, \kvopt{seconds}{true} and \kvopt{$<$datetype$>$time}{24h}.
