...
Note that the set of characters allowed and usable in the string for \bibfield{entrykey} depends on the used the backend (\biber, \bibtex) as well as the \latex engine (\pdflatex, \lualatex, \xelatex).
