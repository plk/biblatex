...
Declares the \prm{name} as a datamodel constant with definition \prm{constantdef}. Such constants are typically used internally by the \biber backend and constants in the default data model should rarely be redefined. They may however be of use to style authors.
