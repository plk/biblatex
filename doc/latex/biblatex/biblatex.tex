...
\end{lstlisting}
%
With fallback enabled and global variant settings \opt{vform} <original> and \opt{vlang} <\texttt{*}>, the selected \bibfield{BOOKTITLE} and \bibfield{TITLE} fields for printing will be:
