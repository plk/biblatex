...
\intitem[\prm{maxnames}]{maxsortnames}

Similar to \opt{maxnames} but affects only the names visible to sorting.

\intitem[\prm{minnames}]{mincitenames}

Similar to \opt{minnames} but affects only the citations in the document body.

\intitem[\prm{minnames}]{minsortnames}

Similar to \opt{minnames} but affects only the names visible to sorting.
