...
\cmditem{volcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
\cmditem{Volcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
...
\cmditem{pvolcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
\cmditem{Pvolcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
...
\cmditem{fvolcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
\cmditem{Fvolcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
...
\cmditem{svolcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
\cmditem{Svolcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
...
\cmditem{tvolcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
\cmditem{Tvolcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
...
\cmditem{avolcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
\cmditem{Avolcites}(pre)(post)[pre]{volume}[page]{key}|...|[pre]{volume}[page]{key}
...
\valitem{contenttype}{field contenttype}

Sets the semantic type of the content of the field. This is useful for discriminating between fields on the basis of their semantic content. For example, \biber uses this internally for certain things. By default, only the fields specifying parts of dates use this and the value is set to <datepart>. You will not normally ever need to change/set this and it is only visible here for completeness.
...
\item Added new citation delimiter \cmd{textcitedelim} for \cmd{textcite} and related commands into standard styles\see{aut:fmt:fmt}
\end{release}
