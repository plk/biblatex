...
Similar to \opt{maxnames} but affects only the names visible to sorting. Since this defaults to \prm{maxbibnames}, you should set this after \prm{maxbibnames} if \prm{maxbibnames} is explicitly set.
...
Similar to \opt{minnames} but affects only the names visible to sorting. Since this defaults to \prm{minbibnames}, you should set this after \prm{minbibnames} if \prm{minbibnames} is explicitly set.
