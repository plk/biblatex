...
\optitem[secular]{dateera}{\opt{secular}, \opt{christian}}

This option controls which localisation strings are used to format date era information (see \secref{aut:lng:key:era}). By default, secular eras are used and only printed for BC/BCE dates. If set, \cmd{dateeraprint} will be used to format the era information, see \secref{use:fmt:fmt}.
