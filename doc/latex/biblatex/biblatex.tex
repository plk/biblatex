...
\intitem[2]{minxrefs}\BiberOnlyMark

As \opt{mincrossrefs} but for \bibfield{xref} fields. With \bibtex as the
backend, the \opt{mincrossrefs} option sets the threshhold for both
\bibfield{crossref} and \bibfield{xref}.
...
\boolitem[false]{uniqueprimaryauthor}\BiberOnlyMark
...
\subsection{Data Annotations}\BiberOnlyMark
\label{use:annote}
...
\item Added data annotation feature\see{use:annote}\BiberOnlyMark
\item Added package option \opt{minxrefs}\see{use:opt:pre:gen}\BiberOnlyMark
