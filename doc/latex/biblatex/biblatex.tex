...
\begin{table}
\tablesetup
\begin{tabularx}{\textwidth}{@{}p{50pt}@{}p{150pt}@{}X@{}}
\toprule
...
\cmditem{mainlang}{code}

Executes \prm{code} after locally switching from the current language to the main document language. This can be passed as the \prm{wrapper} argument to \cmd{bibstring} and other commands for printing localization strings.
