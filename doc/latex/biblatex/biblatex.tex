...
\noindent It is possible to add to a loaded data model by using the macros below in your preamble. You cannot define an entire data model this way however as \biblatex will have loaded a data model from one of the locations described above by the time preamble macros are reached. The data model is defined using the following macros:
