...
\listitem{expireddate}{date}

The date of expiration for a \bibtype{patent}. Patents usually (with a lot of legal exception depending of countries) expire twenty years after filling. This date could be set in order to document that the
\bibtype{patent} has expired earlier than expected (usually due to fee not payed).
...
\listitem{fileddate}{date}

The  date of filing for a \bibtype{patent}. \bibfield{fileddate} is usually the beggining of the legal monopole.
...
\listitem{granteddate}{date}

The granted date for a \bibtype{patent}.
...
\fielditem{publisheddate}{date}

An alias for \bibfield{date}, provided for legal database compatibility.
