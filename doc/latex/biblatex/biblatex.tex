...
This option sets the integer number for CE/AD years, below which era localisation strings are automatically be added. This option does nothing without \opt{dateera} being set to <secular> or <christian>.
