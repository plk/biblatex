...
\end{itemize}
%
See \tabref{bib:use:tab2} for examples.
...
\iffieldundef{labeldatesource}
  ...
  {\iffieldundef{\thefield{labeldatesource}year}
    {
      % labeldatesource contains a non-date field since if a date
      % is defined by a date field, there is at least a year
    }
    {
      % labeldatesource contains a date field name
