...
\cmditem{citelist}[prenote][postnote]{key}[format][form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{literal list}
...
\cmditem{citefield}[prenote][postnote]{key}[format][form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{field}
...
\BiberOnlyMark Commands which support variant enabled fields allow the specification of optional 
\prm{form} and/or \prm{lang} keyval options, see \secref{bib:fld:var} in which case they operate on only the specified field variant. When selecting a particular language variant of the field using the \prm{form} and/or \prm{lang} options, the \opt{autolangshort} package option determines which Babel/Polyglossia language environment to use when printing the field/list. The \opt{autolangshortstrings} package option determines whether localization string switching will be performed in addition to Babel/Polyglossia language environment switching. See the example in \cmd{printlist} below.

\begin{ltxsyntax}

\cmditem{printfield}[format][form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{field}
...
\cmditem{printlist}[format][start\ensuremath\rangle--\ensuremath\langle stop][form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{literal list}
...
\cmditem{printnames}[format][start\ensuremath\rangle--\ensuremath\langle stop][form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{name list}
...
\cmditem{savefield}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{field}{macro}
\cmditem*{savefield*}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{field}{macro}
...
\BiberOnlyMark For variant enabled fields, saves all field variants unless a specific variant is specified with the \prm{form} and/or \prm{lang} options. You will receive a warning if you specify a \prm{form} and/or \prm{lang} for a field which is not variant enabled.

\cmditem{savelist}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{literal list}{macro}
\cmditem*{savelist*}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{literal list}{macro}
...
\BiberOnlyMark For variant enabled lists, saves all list variants unless a specific variant is specified with the \prm{form} and/or \prm{lang} options. You will receive a warning if you specify a \prm{form} and/or \prm{lang} for a list which is not variant enabled.

\cmditem{savename}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{name list}{macro}
\cmditem*{savename*}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{name list}{macro}
...
\BiberOnlyMark For variant enabled name lists, saves all name list variants unless a specific variant is specified with the \prm{form} and/or \prm{lang} options. You will receive a warning if you specify a \prm{form} and/or \prm{lang} for a name list which is not variant enabled.

\cmditem{savefieldcs}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{field}{csname}
\cmditem*{savefieldcs*}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{field}{csname}
...
\cmditem{savelistcs}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{literal list}{csname}
\cmditem*{savelistcs*}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{literal list}{csname}
...
\cmditem{savenamecs}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{name list}{csname}
\cmditem*{savenamecs*}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{name list}{csname}
...
\cmditem{restorefield}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{field}{macro}

Restores a \prm{field} from a \prm{macro} defined with \cmd{savefield} before. The field is restored within a local scope.\\
\BiberOnlyMark For variant enabled fields, restores all field variants unless a specific variant is specified with the \prm{form} and/or \prm{lang} options. You will receive a warning if you specify a \prm{form} and/or \prm{lang} for a field which is not variant enabled.

\cmditem{restorelist}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{literal list}{macro}

Restores a \prm{literal list} from a \prm{macro} defined with \cmd{savelist} before. The list is restored within a local scope.\\
\BiberOnlyMark For variant enabled lists, restores all list variants unless a specific variant is specified with the \prm{form} and/or \prm{lang} options. You will receive a warning if you specify a \prm{form} and/or \prm{lang} for a list which is not variant enabled.

\cmditem{restorename}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{name list}{macro}

Restores a \prm{name list} from a \prm{macro} defined with \cmd{savename} before. The list is restored within a local scope.\\
\BiberOnlyMark For variant enabled name lists, restores all name list variants unless a specific variant is specified with the \prm{form} and/or \prm{lang} options. You will receive a warning if you specify a \prm{form} and/or \prm{lang} for a name list which is not variant enabled.

\cmditem{clearfield}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{field}
...
\BiberOnlyMark For variant enabled fields, clears all field variants unless a specific variant is specified with the \prm{form} and/or \prm{lang} options. You will receive a warning if you specify a \prm{form} and/or \prm{lang} for a field which is not variant enabled.

\cmditem{clearlist}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{literal list}
...
\BiberOnlyMark For variant enabled lists, clears all list variants unless a specific variant is specified with the \prm{form} and/or \prm{lang} options. You will receive a warning if you specify a \prm{form} and/or \prm{lang} for a list which is not variant enabled.

\cmditem{clearname}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{name list}
...
\BiberOnlyMark For variant enabled name lists, clears all name list variants unless a specific variant is specified with the \prm{form} and/or \prm{lang} options. You will receive a warning if you specify a \prm{form} and/or \prm{lang} for a name list which is not variant enabled.
...
\cmditem{iffieldsequal}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{field 1}[form=\opt{form}\ensuremath\rangle,\ensuremath\langle lang=\opt{lang}]{field 2}{true}{false}
