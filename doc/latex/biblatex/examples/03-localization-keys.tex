...
The localization keys listed in this document are defined by default. Each key is printed with its description from the manual and strings specified by \vrb{\languagename.lbx} in following format.
\begin{verbatim}
...
The following strings are special because they are intended for use in headings and made available globally via macros. For this reason, they should be capitalized for use in headings and they must not include any local commands which are part of the author interface.
