...
% the option passed to 'babel'.
%
\documentclass{article}

% Ascii localization modules
...
<key name>  <long string>
            <short string>
\end{verbatim}
The arguments \cmd{lsmarttext} and \cmd{ssmarttext} are passed to long and short strings ending with \cmd{smartof}-type commands, respectively, which can be redefined in this document's preamble. Any unspecified keys will appear in boldface and generate warnings in the \vrb{log} file. String definitions or corrections are welcome at:
\begin{center}
