...
\usepackage[style=authoryear,%
            % julian=true,% uncomment to convert dates between julianstart
                          % and julianend to Julian Calendar
            % julianend=1582-10-15,% Default
            % julianstart=0001-01-01,% To restrict Julian conversion to CE years
            alldates=short,%
