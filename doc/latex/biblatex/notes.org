...
** TODO vform and vlang are global and per-entry. vlang defaults to babel/polyglossia setting or global language option. vform to "original"
** TODO vtranslang is global and per-entry., defaults in same way as vlang
** TODO Did I mention why it doesn't make sense to variant related functionality?
** TODO \DeclareLabel* are variant compatible \field[]{} doc needs enhancing.
