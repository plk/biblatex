...
** DONE Some problem with related fields - clear* are clearing global - not good
* New macros needed
** \ifbibfieldmsvar (Are there any forms/langs variants other than orig_default for bibfield?)
** \loopforms and \looplangs (loop over all forms/langs doing macro for each)
** \gettranslang (get the lang of a translated form)
** beglang/endlang?
* Documentation
...
** \ifbibfieldlang{bibfield}{<form>}{<lang>} (if there is a <lang> for <form> for bibfield?)
