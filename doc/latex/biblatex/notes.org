...
** form/lang should be global and per-entry, passed in bcf. Then biber uses the active form/lang and only omits these for .bbl when the same.
** What does the language field do? clearlang? babel option
**** \blx@mkbabel/\blx@mknobabel
* New macros needed
...
** global multiscriptform option - multiscriptlang comes from language option
